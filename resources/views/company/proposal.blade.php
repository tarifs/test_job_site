                			 ...
                			 <ul class="list-unstyled">
                                    <li class="mb-2">
                                        @if(!empty($applicant->photo))
                                           <p class="text-center"><img src="{{ asset($applicant->photo) }}" class="img-fluid w-50 h-50 rounded-circle"></p> 
                                        @else 
                                    ...
                                    <li class="mb-2">
                                     ...
                                     @if ($applicant->status == 'approved')
                                        <td class="text-center">
                                          <h4 class="text-center"><span class="badge badge-success w-100"><i class="fas fa-check"></i> <strong>APPROVED</span></h4>
                                       </td>
