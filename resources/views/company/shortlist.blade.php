                               ...
                               @foreach($applicants->sortByDesc('created_at') as $applicant )
                                    <tr>
                                        ...
                                        @if(!empty($applicant->photo))
                                         <td class="text-center" ><img src="{{ asset($applicant->photo) }}" class="p-0 rounded-circle" style="height: 80px"></td> 
                                        @else 
                                     ...
                                     @if ($applicant->status == 'approved')
                                        <td>
                                          <h4><span class="badge badge-success w-100"><i class="text-white fas fa-check"></i> <strong>APPROVED</strong></span></h4>
                                       </td>
